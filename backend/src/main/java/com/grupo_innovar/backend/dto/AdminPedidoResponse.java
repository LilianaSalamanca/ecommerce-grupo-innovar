...
public class AdminPedidoResponse {
    ...
    // NUEVO
    private List<AdminDetallePedido> productos;

    public AdminPedidoResponse() {}
    ...
    public List<AdminDetallePedido> getProductos() { return productos; }
    public void setProductos(List<AdminDetallePedido> productos) { this.productos = productos; }
}